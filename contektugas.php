  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <?php
        if(isset($_SESSION['email'])){
          include "connect.php";
          $query = "CALL sp_daftar_contek('$_GET[tugas]')";
         ...
         if (mysqli_num_rows($sql)!=0){
            while ($row = mysqli_fetch_assoc($sql)){
              ...
              */
              ...
              ?>
                  ...
                  <div class="col s4">
                    <div class="card">
                      <span class="card-title" style="font-size: 20px; text-align: center;"><?php echo "$row[u_name]"; ?></span>
                      <div class="card-content">
                      </div>

                      <div class="card-action">
                        <?php echo "<a href='kerja.php?tugas=$_GET[tugas]&cara=2'>"; ?>
                        <?php 
                          if ($_SESSION['id']==$row['id']){
                            echo "Salin tugas sendiri cie</a><br>";
                          }
                          else {
                            echo "Salin</a><br>";
                          }
            ...
            echo "<p>Tidak ada user yang sedang mempunyai tugas ini</p>";
          }
          mysqli_close($db);
        }
