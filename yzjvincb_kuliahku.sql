...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2017 at 08:54 AM
...
CREATE TABLE `mata_kuliahs` (
  `id` int(10) UNSIGNED NOT NULL,
  `nama_matkul` varchar(191) DEFAULT NULL,
  `sks_juml` int(11) DEFAULT NULL,
  `knowledge_juml` int(11) DEFAULT NULL,
  `energi_req` int(11) DEFAULT NULL,
  `tugas_count_req` int(11) DEFAULT NULL
...
(2, 'Perancangan dan Analisis Algoritma', 3, 100, 20, 2),
